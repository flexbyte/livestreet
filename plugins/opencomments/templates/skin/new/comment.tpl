                ...
                <!-- oc -->
                {if !$oUser->getId() }
                <p class="guest"><b>{$oComment->getGuestName()}</b>&nbsp;&nbsp;&nbsp;<i><small>{$aLang.opencomments_guest}</small></i></p>
                {else}
                ...
                <!-- /oc -->
								...
								<ul>
									...
									{if $oConfig->GetValue('opencomments.enabled') and !$oComment->getDelete() and !$bAllowNewComment}
